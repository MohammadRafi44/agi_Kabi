...
public class RetrieveEmergencyContactsDetail_API extends RestAssuredAPI {
    // --- add this ---
    private static final ReportManager logger = new ReportManager(RetrieveEmergencyContactsDetail_API.class);
    // ----- constructor (keeps defaults in code, actual base URL can still come from Excel) -----
    public RetrieveEmergencyContactsDetail_API() {
    ...
    public Map<String, String> getRetrieveEmergencyContactsDetail_ApiDetails(String reference) throws Exception {
...
/*    public Map<String, String> getCafmWorkOrderAPIDetails(String reference) throws Exception {
    ...
    public ApiResponse retrieveEmergencyContactsDetail(Map<String,String> data) {
...
/*        //String url = data.getOrDefault("RequestURL","") + data.getOrDefault("EndPoint","");
    ...
    public void assertRetrieveEmergencyContactsDetail(Map<String,String> data, ApiResponse res) {
        // 1) status code
