...
public class ViewEmployeeProfilePicture_API extends RestAssuredAPI {
    // --- add this ---
    private static final ReportManager logger = new ReportManager(ViewEmployeeProfilePicture_API.class);
    // ----- constructor (keeps defaults in code, actual base URL can still come from Excel) -----
    public ViewEmployeeProfilePicture_API() {
    ...
    public Map<String, String> getRetrieveEmployeeRecord_ApiDetails(String reference) throws Exception {
...
/*    public Map<String, String> getCafmWorkOrderAPIDetails(String reference) throws Exception {
    ...
    public ApiResponse viewEmployeeProfilePicture(Map<String,String> data) {
...
/*        //String url = data.getOrDefault("RequestURL","") + data.getOrDefault("EndPoint","");
    ...
    public void assertViewEmployeeProfilePicture(Map<String,String> data, ApiResponse res) {
        // 1) status code
